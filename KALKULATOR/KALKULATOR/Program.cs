...
namespace KALKULATOR
{
    internal class Program
    {
        ...
        {
            string hitungLagi; // Variabel untuk menyimpan pilihn pengguna (y/n)

            // Perulangan do-while kan menjalankan blok kode setidaknya satu kali
            ...
            do
            {
                ...
                // Menenyakan kepada pengguna apakah ingin menghitung lagi 
        ...
        // Fungsi untuk menempilkan menu pilihan
        ...
        static bool AmbilInputAngka(out double angka1, out double angka2)
        {
            ...
            {
                Console.WriteLine("inputa angka pertama tidak valid ");
